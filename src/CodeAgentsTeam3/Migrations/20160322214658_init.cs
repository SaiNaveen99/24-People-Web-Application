...
namespace CodeAgentsTeam3.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DirectorsDirectorID = table.Column<int>(nullable: true),
                    Year = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Education_Director", x => x.DirectorID);
                    table.ForeignKey(
                        name: "FK_Education_Director_Director_DirectorsDirectorID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Film_Director", x => x.DirectorID);
                    table.ForeignKey(
                        name: "FK_Film_Director_Director_DirectorsDirectorID",
                        column: x => x.DirectorsDirectorID,
                        principalTable: "Director",
                        principalColumn: "DirectorID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "Photos_Director",
                columns: table => new
                {
                    DirectorID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DirectorsDirectorID = table.Column<int>(nullable: true),
                    PhotoNo = table.Column<int>(nullable: false),
                    URL = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Photos_Director", x => x.DirectorID);
                    table.ForeignKey(
                        name: "FK_Photos_Director_Director_DirectorsDirectorID",
                        column: x => x.DirectorsDirectorID,
                        principalTable: "Director",
                        principalColumn: "DirectorID",
                        onDelete: ReferentialAction.Restrict);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("Education_Director");
            migrationBuilder.DropTable("Film_Director");
            migrationBuilder.DropTable("Photos_Director");
